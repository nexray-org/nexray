...
import ControlSnippet from './Output/ControlSnippet';
...
function OverflowHandler(props: ScrollbarProps) {
    ...
    return <Scrollbars style={{ height: height - 90, width: '100%' }} renderThumbVertical={thumbRenderer} renderThumbHorizontal={thumbRenderer} {...props} />;
}
