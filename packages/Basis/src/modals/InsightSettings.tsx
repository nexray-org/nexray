...
export default function InsightSettings() {
    ...
    return (
        <Modal
            visible={isInsightsSettingsDialogOpen}
            onClose={() => setIsInsightsSettingsDialogOpen(false)}
            width="400px"
            pt={0}
        >
            <Modal.Content>
                ...
                <div className='mt-4'>
                    <div className='items-center flex mb-5'>
                        <Toggle checked={config.get('insightsWordWrapEnabled')} onChange={e => config.set('insightsWordWrapEnabled', !config.get('insightsWordWrapEnabled'))} />
            ...
            <Modal.Action passive onClick={() => setIsInsightsSettingsDialogOpen(false)}>Close</Modal.Action>
        </Modal>
    )
}