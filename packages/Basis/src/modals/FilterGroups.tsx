                        ...
                        <div>
                            ...
                            >
                                {([
                                    ...
                                    [72, "3d"],
                                    [168, "1w"],
                                    ["custom", <span className='flex-center'><span className='min-w-[50px] text-left'>Custom</span> <BsCalendar4Week className="scale-125" /></span>],
                                ] as const).map(([value, title]) => value === "custom" ? (
                                    <Button
                                        key={"" + value}
                                        onClick={() => {
                                        ...
                                        className={clsx(
                                            "!flex !font-bold",
                                            usingCustomDateRange && "!bg-g-primary-200 !text-g-primary-700"
                                        )}
                                    >
                                        <Popover
                                            content={() => (
                                    ...
                                    <Button
                                        ...
                                        className={clsx(
                                            "!font-bold",
                                            !usingCustomDateRange && value === selectedFilterRange[1]!.diff(selectedFilterRange[0], 'hours') && "!bg-g-primary-200 !text-g-primary-700"
                                        )}
                                        scale={3 / 5}
                                    >
                                        {title}
