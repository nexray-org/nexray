                ...
                <div className='mt-4'>
                    ...
                    <div className='relative'>
                        ...
                        <span className='text-[10px] text-gray-500 inline-block mt-4'>
                            By default, this functionality uses a hosted Shuttle API. No data is logged and{' '}
                            <Link target={'_blank'} color href='https://github.com/dilan-dio4/basis/tree/main/etc/json-finder'>
                                the source can be seen here
                            </Link>
                            . You can self-host that endpoint with the <span className='underline'>parseCustomFindJsonRoute</span> attribute in your
                            configuration file.
                        </span>
                    </div>
                </div>
