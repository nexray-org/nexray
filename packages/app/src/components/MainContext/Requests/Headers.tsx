...
const SectionHeader = ({ children }: { children: string }) => (
    <div className='h-[28px] flex items-center pl-4 border-b border-b-g-primary-700'>
        <span className='leading-none text-xs tracking-normal text-g-primary-300 font-semibold'>{children}</span>
    </div>
);
